      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            ...
            {/* Column 1: Logo & Brand - Enhanced and Bigger */}
            <div className="text-center md:text-left md:col-span-1">
              ...
              <p className="text-white/90 text-base leading-relaxed max-w-xs mx-auto md:mx-0">
                Experience luxury living in Tel Aviv's vibrant Kerem HaTeimanim neighborhood with our premium accommodations and exceptional concierge services.
              </p>
            </div>
            
            {/* Column 2: Contact - Enhanced */}
            <div className="text-center md:text-left">
              <h3 className="font-playfair text-2xl font-bold text-secondary mb-6">Contact Us</h3>
              
              <div className="space-y-4">
                <div className="group">
                  <div className="flex items-center justify-center md:justify-start group-hover:bg-white/10 rounded-lg p-3 transition-colors duration-300">
                    <Mail className="w-5 h-5 text-secondary mr-3 flex-shrink-0 group-hover:scale-110 transition-transform duration-300" />
                    <a 
                      href="mailto:keremliving@gmail.com" 
                      className="text-white/90 hover:text-secondary transition-colors duration-300 text-base font-medium"
                    >
                ...
                <div className="group">
                  <div className="flex items-center justify-center md:justify-start group-hover:bg-white/10 rounded-lg p-3 transition-colors duration-300">
                    <span className="text-secondary mr-3 text-lg group-hover:scale-110 transition-transform duration-300">📞</span>
                ...
                <div className="pt-2 flex justify-center md:justify-start">
                  <a 
                    ...
                    className="inline-flex items-center justify-center w-12 h-12 bg-white/10 hover:bg-white/20 rounded-xl transition-all duration-300 group border border-white/20"
            ...
            <div className="text-center md:text-left">
              <h3 className="font-playfair text-2xl font-bold text-secondary mb-6">Navigation</h3>
              
              <nav className="space-y-3">
                <Link 
                  href="/properties" 
                  className="block text-white/90 hover:text-secondary hover:translate-x-2 transition-all duration-300 text-base font-medium p-2 rounded-lg hover:bg-white/10"
                >
                  Accommodations
                </Link>
                <Link 
            ...
            {/* Column 4: Legal - Enhanced and Bigger */}
            <div className="text-center md:text-left">
              <h3 className="font-playfair text-2xl font-bold text-secondary mb-6">Policies</h3>
