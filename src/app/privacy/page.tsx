...
import { ArrowUp, ShieldCheck, Printer } from 'lucide-react';
...
export default function PrivacyPage() {
  ...
  const renderCardGrid = (items: { title: string; body: string }[]) => (
  ...
  return (
    <div className="min-h-screen bg-cream pt-24 pb-20">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl border border-primary/10 bg-white p-8 shadow-xl md:p-12">
          <div className="mb-12 text-center" data-animate="fade-up">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-lg leading-relaxed text-black/75">
              This policy explains what personal data Or Hakerem collects, how we use it, and the
          ...
          <section className="mb-10" data-animate="fade-up" data-delay="2">
            ...
            <div className="mt-8 space-y-6">
              <div className="rounded-2xl border border-primary/10 bg-cream/50 p-6 md:p-8">
                ...
                <div className="mt-6">{renderCardGrid(dataYouProvide)}</div>
              </div>
              ...
              <div className="rounded-2xl border border-primary/10 bg-white p-6 md:p-8">
                ...
                <div className="mt-5">{renderBulletList(dataCollectedAutomatically)}</div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10" data-animate="fade-up">
            ...
            <div className="mt-8 rounded-2xl border border-primary/10 bg-cream/50 p-6 md:p-8">
              ...
              <div className="mt-6">{renderCardGrid(legalBases)}</div>
            </div>
          </section>
          ...
          <section className="mb-10" data-animate="fade-up">
            ...
            <div className="mt-8 rounded-2xl border border-primary/10 bg-white p-6 md:p-8">
              ...
              <div className="mt-6">{renderCardGrid(processors)}</div>
            </div>
          </section>
          ...
          <section className="mb-10" data-animate="fade-up">
            ...
            <div className="mt-8 rounded-2xl border border-primary/10 bg-white p-6 md:p-8">
              {renderBulletList(dataRetention)}
            </div>
          </section>
          ...
          <section className="mb-10" data-animate="fade-up">
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-2">
              <div className="rounded-2xl border border-primary/10 bg-white p-6">
                ...
                <div className="mt-5">{renderBulletList(gdprRights)}</div>
              </div>
