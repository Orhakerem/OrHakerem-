...
The main feature of this apartment is the terrace, with amenities such as BBQ, jacuzzi and sea views you can be sure to have an unforgettable experience and leave with wonderful memories!`,
    ...
    images: [
      ...
      '/penthouse/chaises_hautes_angle_1.JPG',
      '/penthouse/chaises_hautes_angle_2.JPG',
    ],
    rooms: [
      {
        name: 'Master Bedroom',
...
'/studio/cuisine_angle_2',
'/studio/salle_de_bain_angle_1',
'/studio/chambre_angle_3',
'/studio/salon_angle_3',
'/studio/salon_angle_2',
'/studio/salle_de_bain_angle_2',
'/studio/chambre_angle_2',
'/studio/chambre_angle_1',
'/studio/cuisine_angle_1',
'/studio/salon_angle_3_Zoom',
'/studio/salle_de_bain_angle_2',
'/studio/salon_angle_4',
'/studio/Canape_ouvert_angle_1',
'/studio/salon_angle_1.jpg',
'/studio/lit_angle_1.jpg',
'/studio/salon_angle_1_Zoom.jpg',
'/studio/cuisine_angle_2',
